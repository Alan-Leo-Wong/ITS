function(add_lib module_name)
    # Check module name
    if(NOT ${module_name} MATCHES "^ITS_")
        message(FATAL_ERROR "ITS module name should start with 'ITS_'")
    endif()
    string(REPLACE "ITS_" "" module_shortname ${module_name})
    ...
    # Alias target name
    message(STATUS "Creating ${TARGET_KIND} target: ITS::${module_shortname} (${module_name})")
    add_library(ITS::${module_shortname} ALIAS ${module_name})
...
function(add_cuda_lib module_name)
    # Check module name
    if(NOT ${module_name} MATCHES "^ITS_")
        message(FATAL_ERROR "ITS module name should start with 'ITS_'")
    endif()
    ...
    # Alias target name
    message(STATUS "Creating ${TARGET_KIND} CUDA target: ITS::${module_shortname} (${module_name})")
    add_library(ITS::${module_shortname} ALIAS ${module_name})
...
function(add_dir_cuda_libs directories library_list)
    # dir是完整的绝对路径
    foreach (dir ${directories})
        # Get all source files in the current directory
        file(GLOB lib_src_files "${dir}/*.h" "${dir}/*.hpp" "${dir}/*.cu")
